...
!
!> \file
!> The ai_optics_single_scatter_albedo module

!> The optics_single_scatter_albedo_t type and related functions
module ai_optics_single_scatter_albedo
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  !> Constructor of optics_single_scatter_albedo_t object
  function constructor( native_grid, output_grid, accessor,                   &
    ...
    type(optics_single_scatter_albedo_t), pointer :: new_optics
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  type(string_t) function property_name( this )
    ...
    class(optics_single_scatter_albedo_t), intent(in) :: this

    property_name = "single scatter albedo"
...
end module ai_optics_single_scatter_albedo
